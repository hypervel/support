 ...
 * @method static string string(string $key, null|callable|string $default = null)
 * @method static int integer(string $key, null|callable|int $default = null)
 * @method static float float(string $key, null|callable|float $default = null)
 * @method static bool boolean(string $key, null|bool|callable $default = null)
 * @method static array array(string $key, null|callable|array $default = null)
