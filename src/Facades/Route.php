 ...
 * @method static void bind(string $param, string|Closure $modelClass)
 * @method static null|string getModelBinding(string $param)
 * @method static null|Closure getExplicitBinding(string $param)
